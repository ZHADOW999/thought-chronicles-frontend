...
<div data-dial-init className="fixed end-6 bottom-6 group">
    ...
    <button type="button" data-dial-toggle="speed-dial-menu-default" aria-controls="speed-dial-menu-default" aria-expanded="false" className="flex items-center justify-center text-white bg-bg-color-dark rounded-full w-14 h-14 hover:bg-text-color dark:bg-white dark:hover:bg-text-color focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-gray-600">
