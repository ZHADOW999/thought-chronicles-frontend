...
const NewBlog = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            const res = await api.post('/api/blogs', post, {
            headers: {
    ...
    return (
        <div className="sm:mt-20 mt-12 sm:w-[85%] w-[90%] m-auto pb-10">
            ...
            {showPopup && (
                <div className="transition-all duration-300 ease-in-out fixed bottom-20 left-1/2 transform -translate-x-1/2 bg-red-600 text-white p-4 rounded shadow-lg">
